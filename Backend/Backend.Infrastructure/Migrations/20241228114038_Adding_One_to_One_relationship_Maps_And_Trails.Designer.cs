...
namespace Backend.Infrasturcture.Migrations
{
    ...
    [Migration("20241228114038_Adding_One_to_One_relationship_Maps_And_Trails")]
    partial class Adding_One_to_One_relationship_Maps_And_Trails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Domain.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Image = "",
                            Name = "Admin",
                            Password = "$2a$13$IGG88zBYcSYhItBrtjwF2.fQm8srV3fjFoLpc1Ots7j/RBOllAqwG",
                            RoleId = 1
                        });
                });
