...
namespace Backend.Infrasturcture.Migrations
{
    ...
    [Migration("20250312062437_AddedLocationFieldInTrailEntity")]
    partial class AddedLocationFieldInTrailEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Domain.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Image = "",
                            Name = "Admin",
                            Password = "$2a$13$gk4.tHXFNCy4AnjA/CEEqeSxXavkdrxvRH7yqeP/r32MRzgLYjbFi",
                            RoleId = 1
                        });
                });
